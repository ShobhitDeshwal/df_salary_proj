# -*- coding: utf-8 -*-
"""
Created on Sat Jan 16 17:30:56 2021
...
df = pd.read_csv('C:/Users/shobhit deshwal/Desktop/Ken_Jee_salary_pred/eda_data.csv')
...
df_model = df[['avg_salary','Rating','Size','Type of ownership','Industry','Sector','Revenue'
             ,'job_state','age','python_yn','spark','aws','excel','job_simp','seniority',
             'desc_len']]
